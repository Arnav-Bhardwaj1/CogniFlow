...
A full-stack workflow automation platform featuring a visual node-based editor, multi-trigger execution engine, AI-assisted workflow generation, and distributed background job orchestration.

**🌐 Live Demo:** https://thecogniflow.in

## Features

- **Visual Workflow Editor** — Node-based canvas built with React Flow for composing and connecting workflow nodes
