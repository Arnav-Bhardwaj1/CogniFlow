...
import { CredentialType } from "@/app/generated/prisma/wasm";
import {
    Select,
    SelectItem,
    SelectTrigger,
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        className="min-h-20 p-2 text-xs sm:text-sm font-mono"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        className="min-h-30 p-2 text-xs sm:text-sm font-mono"
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
