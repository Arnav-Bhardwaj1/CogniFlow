...
import { ExecutionStatus } from "@/app/generated/prisma";
...
export const ExecutionView = ({ executionId }: { executionId: string }) => {
    ...
    return (
        <Card className="shadow-none w-full max-w-full overflow-hidden glass">
            <CardHeader>
                ...
                {execution.error && (
                    <div className="mt-6 p-4 bg-red-500/10 border border-red-500/20 rounded-md space-y-3">
                        <div>
                            ...
                            <p className="text-sm text-red-300 font-mono break-all">{execution.error}</p>
                        </div>
                        ...
                        {execution.errorStack && (
                            ...
                            >
                                ...
                                <CollapsibleContent>
                                    <pre className="text-xs mt-2 p-2 bg-red-500/10 rounded text-red-300 font-mono overflow-auto max-w-full whitespace-pre-wrap break-words">
                                        {execution.errorStack}
                                    </pre>
                                </CollapsibleContent>
                            </Collapsible>
