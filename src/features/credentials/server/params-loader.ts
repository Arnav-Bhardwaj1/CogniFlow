...
export const credentialsParamsLoader = createLoader(credentialsParams); // what does this loader load? It loads the parameters defined in the credentialsParams module. Loading means fetching or retrieving these parameters so they can be used in the application. 
