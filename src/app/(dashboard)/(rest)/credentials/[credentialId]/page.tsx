...
const Page = async ({ params }: PageProps) => { // where are the params coming from? they are coming from the file name [credentialId], nextjs is passing the value of credentialId as a param to this page component
    await requireAuth();
